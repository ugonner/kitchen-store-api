...
<div class="tab-pane fade show active" id="nav-manage-facilitys" role="tabpanel" aria-labelledby="nav-manage-facilitys-tab">
    <div class="row"  style="margin-top: 40px;">
            ...
            <div class="py-0 form-group">
                <form method="post" action="{{route('userspanel')}}">
                    <div class="form-group form-row">
                        <div class="col col-2 form-group">    <label for="searchfacility" class="col-form-label">search facility</label> </div>
                        <div class="col col-8"> <input type="search" class="input-lg form-control form-control-lg" id="searchfacility" debounce="5"> </div>
        ...
        <div class="col-sm-6">
            @if (!empty($Selectedfacilitys))
            @foreach ($Selectedfacilitys as $SUs)
            <div class="row">
    ...
    <div class="row">
        <h1 class="text-center">Add New facility <a href="{{route('adminfacilityform')}}" class="material-icons">add</a> </h1>
    </div>

    <div class="row">
        <div class="col-12">
            @if (!empty($Adminfacilitys))
            <div class="row">{{ $Adminfacilitys->links() }}</div>
            @foreach ($Adminfacilitys as $AUs)
            <div class="row">
                ...
                <div class="col-1"><button class="btn bg-transparent"  title="More Details" data-content="Event category: {{$AUs->facilitycategoryname}} <br/>| Category: {{$AUs->categoryname}} <br/>| <small><span class='material-icons'>view</span> {{$AUs->no_of_views}} | <small><span class='material-icons'>comment</span> {{$AUs->no_of_comments}}</small>" data-toggle="popover" data-trigger="focus" data-html="true"  data-placement="auto"><span class="rounded-pill small material-icons">more_vert</span> </button></div>
                <!--<div class="col-2"><button class="btn btn-link" onclick="function(facility){facility.target.prfacilityDefault(); document.getElementById('getfacility_form').submit();}"><span class="material-icons">create</span> </button> </div>
                -->
                <div class="col-1">
                    <form method="get" action="{{route('updatefacility')}}" id="getfacility_form">
                        @csrf
                        <input type="hidden" name="facilityid" value="{{$AUs->id}}">
...
<div class="tab-pane fade" id="nav-manage-categories" role="tabpanel" aria-labelledby="nav-manage-categories-tab">
    ...
    @foreach ($facilitycategories as $r)
    <br/><br/>&nbsp;
    <div class="row">
    ...
    <div class="row collapse" id="editcategory{{$r->id}}">
        <div class="form-row" >
            <div class="form-group">
                <form method="post" action="{{route('edit_facilitycategory')}}">
                    @csrf
                    <div class="row">
    ...
    <div class="row">
        <div class="col-sm-12">
            <h1 class="text-center"> Add New facility category <button data-target="#addcategory" data-toggle="collapse" class="btn bg-transparent material-icons">add</button></h1>

            <div class="row collapse" id="addcategory">
                <div class="" >
                    <div class="">
                        <form method="post" action="{{route('create_facilitycategory')}}">
                            @csrf
                            <div class="row">
                                <div class="col-sm-3 form-group">
                                    <input type="hidden" name="r" value="true">
...
<div class="tab-pane fade" id="nav-manage-positions" role="tabpanel" aria-labelledby="nav-manage-positions-tab">
    ...
    @foreach ($facilitycertificationlevels as $r)
    <br/><br/>&nbsp;
    <div class="row">
        <div class="col-sm-2"></div>
        <div class="col-sm-4">
    ...
    <div class="row collapse" id="editcertificationlevel{{$r->id}}">
        <div class="form-row" >
            <div class="form-group">
                <form method="post" action="{{route('edit_facilitycertificationlevel')}}">
                    @csrf
                    <div class="row">
                        <div class="col-sm-3 form-group">
                            <input type="hidden" name="r" value="true">
    ...
    <div class="row">
        <div class="col-sm-12">
            <h1 class="text-center"> Add New facility certification level <button data-target="#addcertificationlevel" data-toggle="collapse" class="btn bg-transparent material-icons">add</button></h1>

            <div class="row collapse" id="addcertificationlevel">
                <div class="" >
                    <div class="">
                        <form method="post" action="{{route('create_facilitycertificationlevel')}}">
                            @csrf
                            <div class="row">
                                <div class="col-sm-3 form-group">
                                    <input type="hidden" name="r" value="true">
