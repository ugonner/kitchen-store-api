        ...
        <div class="col-sm-8">
            ...
            <div class="form-group">
                <form method="POST" action="{{ route('adminreg') }}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group custom-file">
                                <label for="imageurl" class="custom-file-label">{{ __('Upload Profile Picture')}}</label>
                    ...
                    <div class="row">
                        <div class="form-group">
                            <button type="submit" class="rounded-pill btn btn-primary btn-lg btn-block">
                                {{ __('Register') }}
                            </button>
                        </div>
                    </div>
