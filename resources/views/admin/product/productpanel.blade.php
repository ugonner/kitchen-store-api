...
<nav>
    <div class="nav nav-tabs" id="nav-tab" role="tablist">
        <button type="button" class="nav-item nav-link btn-lg bg-transparent active" id="nav-manage-products-tab" data-toggle="tab" data-target="#nav-manage-products" role="tab" aria-controls="nav-manage-products" aria-selected="false">Manage products</button>
...
<div class="tab-content" id="nav-tabContent">
    <div class="tab-pane fade show active" id="nav-manage-products" role="tabpanel" aria-labelledby="nav-manage-products-tab">
        <div class="row"  style="margin-top: 40px;">
            <div class="col-sm-6">
                <div class="py-0 form-group">
                    <form method="post" action="{{route('userspanel')}}">
                        <div class="form-group form-row">
                            <div class="col col-2 form-group">    <label for="searchproduct" class="col-form-label">search product</label> </div>
                            <div class="col col-8"> <input type="search" class="input-lg form-control form-control-lg" id="searchproduct" debounce="5"> </div>
            ...
            <div class="col-sm-6">
                ...
                @foreach ($Selectedproducts as $SUs)
                <div class="row">
        ...
        <div class="row">
            <h1 class="text-center">Add New product <a href="{{route('adminproductform')}}" class="material-icons">add</a> </h1>
        </div>

        <div class="row">
            <div class="col-12">
                @if (!empty($Adminproducts))
                <div class="row">{{ $Adminproducts->links() }}</div>
                @foreach ($Adminproducts as $AUs)
                <div class="row">
    ...
    <div class="tab-pane fade" id="nav-manage-categories" role="tabpanel" aria-labelledby="nav-manage-categories-tab">
        ...
        <div class="row collapse" id="editcategory{{$r->id}}">
            <div class="form-row" >
                <div class="form-group">
                    <form method="post" action="{{route('edit_productcategory')}}">
                        @csrf
                        <div class="row">
        ...
        <div class="row">
            <div class="col-sm-12">
                <h1 class="text-center"> Add New product category <button data-target="#addcategory" data-toggle="collapse" class="btn bg-transparent material-icons">add</button></h1>

                <div class="row collapse" id="addcategory">
                    <div class="" >
                        <div class="">
                            <form method="post" action="{{route('create_productcategory')}}">
                                @csrf
                                <div class="row">
                                    <div class="col-sm-3 form-group">
                                        <input type="hidden" name="r" value="true">
